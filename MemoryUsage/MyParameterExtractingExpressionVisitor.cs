...
{
    public class MyParameterExtractingExpressionVisitor : ExpressionVisitor
    {
        ...
        {
            var visitor = new MyParameterExtractingExpressionVisitor(evaluatableExpressionFilter, queryContext, logger);
        ...
        private MyParameterExtractingExpressionVisitor(
            ...
            if (declaringType == typeof(Queryable)
                ...
                && (!methodInfo.IsGenericMethod
                    || !methodInfo.GetGenericMethodDefinition()
                                  .Equals(StringIncludeMethodInfo)))
            {
